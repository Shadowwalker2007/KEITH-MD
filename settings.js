...
const author = process.env.STICKER_AUTHOR || 'Innocent Mandishona';
const packname = process.env.PACKNAME || 'shadowwalker v2';
const dev = process.env.DEV || '263714183261';
const DevKeith = dev.split(",");
const botname = process.env.BOTNAME || 'SHADOW WALKER V2 BOT2';
